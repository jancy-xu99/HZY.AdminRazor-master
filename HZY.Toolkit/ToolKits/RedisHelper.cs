...
namespace HZY.Toolkit.ToolKits
{
    public class RedisHelper
    {
        ...
        public static  string redisconn= "192.168.173.7";
        ...
        public static void LoadConnection()
        {
            ...
            {
                _conn = redisconn;//ConvertUtils.ConvertToString(ConfigurationHelper.GetAppSettings<RedisConnectionStrings>("RedisConnectionStrings").RedisConnection);
                _RedisInvalidTime = 30; //ConvertUtils.ConvertToInt(ConfigurationHelper.GetAppSettings<RedisConnectionStrings>("RedisConnectionStrings").RedisInvalidTime);
